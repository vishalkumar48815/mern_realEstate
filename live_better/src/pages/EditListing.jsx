...
const EditListing = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:5000/api/listing/update/${params.id}`, payload);
        ...
        <form className="flex flex-col lg:flex-row gap-6 my-10" onSubmit={handleFormSubmit}>
            ...
            <div className="flex flex-col flex-1 gap-3">
                ...
                <div className="flex gap-3">
                    <input type="file" className="p-3 rounded-md border border-slate-300 w-full" name="listingImages" id="imagesInput" accept="images./*" onChange={(e) => setFiles(e.target.files)} multiple />
                ...
                <button className="p-3 bg-slate-700 text-white rounded-lg hover:bg-slate-600 disabled:opacity:50 uppercase">{loading ? 'Updating...' : 'Update listing'}</button>
